 ...
 * // Result: 10*50 + 30 + 50 = 580 doubles (~4.6KB)
 *
 * size_t ws_4d = cubic_interp_workspace_size_4d(50, 30, 20, 10);
 * // Result: 10*50 + (30*20*10 + 20*10 + 10) + 50 = 6,760 doubles (~54KB)
 *
 * size_t ws_5d = cubic_interp_workspace_size_5d(50, 30, 20, 10, 5);
 * // Result: 10*50 + (30*20*10*5 + 20*10*5 + 10*5 + 5) + 50 = 31,105 doubles (~249KB)
 *
