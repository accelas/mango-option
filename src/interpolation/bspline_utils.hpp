...
//
// IMPORTANT: These functions are implemented in bspline_utils.cpp to avoid
// IFUNC circular dependencies in shared library builds. Do NOT make them inline
// or define them in the header.
