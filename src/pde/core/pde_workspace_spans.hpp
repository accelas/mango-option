#ifndef MANGO_PDE_CORE_PDE_WORKSPACE_SPANS_HPP
#define MANGO_PDE_CORE_PDE_WORKSPACE_SPANS_HPP
...
/**
 * PDEWorkspaceSpans: Named spans to caller-managed PMR buffers
 *
...
#endif  // MANGO_PDE_CORE_PDE_WORKSPACE_SPANS_HPP
