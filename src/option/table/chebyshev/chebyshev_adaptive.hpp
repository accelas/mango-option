...
public:
    ...
    /// Explicit levels are used as supplied. Unrepresentable counts or an
    /// estimated tensor/PDE-sample footprint above 128 MiB return InvalidConfig
    /// before allocating nodes. This is a work limit, not an allocation guarantee.
