...
/// Freezes and certifies the final physical price. A rigorous negative
/// witness and failure to prove within the budget have distinct typed errors.
///
...
[[nodiscard]] std::expected<BSplinePriceTable, PriceTableError>
