...
| **American IV (B-spline surface)** | **~1.1 µs** | **Newton’s method over 4D tensor-product spline (measured via `bazel run //benchmarks:component_performance -- --benchmark_filter=BSpline`)** |
